...
const t = {
  ...
  filterPlotsInSeason: { id: 'Lahan Musim Panen', en: 'Crops In Season' },
  filterOpenVisits: { id: 'Buka Kunjungan', en: 'Open for Visits' },
  inSeason: { id: 'Musim Panen', en: 'In Season' },
  offSeason: { id: 'Luar Musim', en: 'Off Season' },
  openForVisits: { id: 'Buka Kunjungan', en: 'Open for Visits' },
  closedForVisits: { id: 'Tutup Kunjungan', en: 'Closed for Visits' },
  ...
  harvestSeason: { id: 'Status Kunjungan', en: 'Visit Status' },
